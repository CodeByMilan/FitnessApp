...
const Footer = () => {
  return (
    <>
  <>
<footer className="bg-gray-400 dark:bg-gray-900 w-full">
    ...
    <div className="px-2 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a href="https://flowbite.com/">TriMPS SHARK</a>. All Rights Reserved.
        </span>
